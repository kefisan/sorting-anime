...
def process_data(num_rows, file_prefix):
    ...
    sort_and_write(sa.insertion_sort, data, f'output_release_year/{file_prefix}anime_release_year_insertion_sort.csv')
    sort_and_write(sa.quick_sort, data, f'output_release_year/{file_prefix}anime_release_year_quick_sort.csv')
    sort_and_write(sa.heap_sort, data, f'output_release_year/{file_prefix}anime_release_year_heap_sort.csv')
